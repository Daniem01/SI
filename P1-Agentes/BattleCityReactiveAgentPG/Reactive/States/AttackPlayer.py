...
class AttackPlayer(State):
    ...
    def Transit(self, perception, map):
        ...
        # Si hay command center pero el jugador está lejos, vamos a ir hacia el command center para atacarlo
        if distancia > AgentConsts.ATTACK_RANGE and perception[AgentConsts.COMMAND_CENTER_X] > 0:
            return AgentConsts.STATE_GO_CENTER
        # Si no hay command center o el jugador esta lejos vamos a ir a la salida
        elif perception[AgentConsts.COMMAND_CENTER_X] < 0 and distancia > AgentConsts.ATTACK_RANGE:
